...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/nf-provenance-all.css?1.3.0" type="text/css" />
...
<link rel="stylesheet" href="css/nf-common-ui.css?1.3.0" type="text/css" />
        ...
        <script type="text/javascript" src="js/nf/provenance/nf-provenance-all.js?1.3.0"></script>
    </head>
